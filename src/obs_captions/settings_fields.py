...
FIELDS: list[FieldSpec] = [
    ...
    FieldSpec("local.initial_prompt", "인식 힌트(Initial Prompt)", "text", "Local", _GUI,
              help="인식 정확도를 높일 힌트 문장. 예: 방송 주제·자주 나오는 고유명사를 적으면 그 단어를 더 잘 알아듣습니다."),
    FieldSpec("local.hotwords", "강조 단어(Hotwords)", "text", "Local", _GUI,
              help="특히 강조할 단어 목록(공백/줄로 구분)."),
...
_ADVANCED_KEYS: frozenset[str] = frozenset({
    ...
    "local.min_silence_ms", "local.hotwords",
    "server.host", "server.port", "overlay.font_family",
